...
- Working on a Macbook (Apple Silicon), I was implementing ARM64 when I built the infrastructure via terraform. This resulted in very long build times when it came to building my pipelines.
